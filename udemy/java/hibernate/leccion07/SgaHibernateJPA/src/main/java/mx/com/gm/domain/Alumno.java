...
public class Alumno implements Serializable {
    ...
    @ManyToOne(cascade = CascadeType.ALL) //Asociación mucho a uno. CASCADA all para guardar todo a la vez alumno y domicilio
    private Domicilio domicilio;//Obtenemos objetos completos de domicilio

    @JoinColumn(name = "id_contacto", referencedColumnName = "id_contacto")
    @ManyToOne(cascade = CascadeType.ALL)//Asociación mucho a uno. CASCADA all para guardar todo a la vez alumno y contacto
