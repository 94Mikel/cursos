...
CREATE TABLE `alumnos_asignaturas` (
  ...
  PRIMARY KEY (`alumnos_id`,`asignaturas_id`,`fecha`),
  KEY `fk_asi_alu_idx` (`asignaturas_id`),
  CONSTRAINT `fk_alu_asi` FOREIGN KEY (`alumnos_id`) REFERENCES `alumnos` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_asi_alu` FOREIGN KEY (`asignaturas_id`) REFERENCES `asignaturas` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- Dump completed on 2018-03-09 13:33:05
